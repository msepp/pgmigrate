...
export SOURCE_URL="https://github.com/msepp/pgmigrate/archive/refs/tags/$VERSION+commit.$COMMIT.tar.gz"
wget "$SOURCE_URL" -O release.tar.gz
export SOURCE_SHA_256=$(shasum -a 256 release.tar.gz | cut -d ' ' -f 1)
export BOTTLE_ROOT="https://github.com/msepp/pgmigrate/releases/download/$VERSION%2Bcommit.$COMMIT"
